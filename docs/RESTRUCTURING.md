...
- [ ] **3.5 Globals → context (long tail).** No big-bang DI. Introduce a
  ...
  > linked, which the forward-declaration-only headers are for. R1: 325 → 32.
