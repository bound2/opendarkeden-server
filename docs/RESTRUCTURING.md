...
- [ ] **3.5 Globals → context (long tail).** No big-bang DI. Introduce a
  ...
  > registry of non-owning pointers to fifty-three managers, each registered by
  ...
  > linked, which the forward-declaration-only headers are for. R1: 325 → 30.
  ...
  > `g_pMonsterInfoManager` (25), `g_pOptionInfoManager` (22) and
