...
| `src/server/gameserver/Vampire.cpp` | 2,312 (was 2,783 before the 4.3 hoists; enforced by `ratchets.sh` R6i) |
...
| `src/server/gameserver/skill/HitRoll.cpp` | 728 (not a god file — an extraction-target pin, locked in with its 3.3 extraction; enforced by `ratchets.sh` R6c) |
