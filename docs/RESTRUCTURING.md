...
- [ ] **3.5 Globals → context (long tail).** No big-bang DI. Introduce a
  ...
  > linked, which the forward-declaration-only headers are for. R1: 325 → 29.
  ...
  > `g_pVariableManager` (79), `g_pMonsterInfoManager` (25),
  > `g_pOptionInfoManager` (22) and `g_pPKZoneInfoManager` (19), then the
