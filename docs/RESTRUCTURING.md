...
| `src/server/gameserver/skill/SkillUtil.cpp` | 6,642 (enforced by `ratchets.sh` R6a) |
...
| `src/server/gameserver/Slayer.cpp` | 3,597 (was 4,046 before the 4.3 hoists; enforced by `ratchets.sh` R6h) |
| `src/server/gameserver/Vampire.cpp` | 2,316 (was 2,783 before the 4.3 hoists; enforced by `ratchets.sh` R6i) |
