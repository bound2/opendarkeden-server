...
public:
    ...
    void setVolumeWidth(VolumeWidth_t volumeWidth) {
        m_VolumeWidth = volumeWidth;
    }
    ...
    void setVolumeHeight(VolumeHeight_t volumeHeight) {
        m_VolumeHeight = volumeHeight;
    }
...
public:
    void init();
    VolumeInfo* getVolumeInfo(VolumeType_t VolumeType) const {
        return m_VolumeInfo[VolumeType];
    }
    string toString();
