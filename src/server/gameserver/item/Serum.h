...
private:
    ...
    ItemNum_t m_Num;       // Number of serums stacked
...
private:
    int m_HPAmount; // HP recovered per unit of time
    int m_Period;   // Unit of time, in seconds
    int m_Count;    // How many times the unit of time repeats
};
