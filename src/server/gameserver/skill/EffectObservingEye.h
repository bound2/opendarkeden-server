...
public:
    ...
    int getCriticalHitBonus(void) const {
        return m_CriticalHitBonus;
    }
    void setCriticalHitBonus(int bonus) {
        m_CriticalHitBonus = bonus;
    }

    int getVisionBonus(void) const {
        return m_VisionBonus;
    }
    void setVisionBonus(int bonus) {
        m_VisionBonus = bonus;
    }
