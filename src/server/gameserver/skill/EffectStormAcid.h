...
#ifndef __EFFECT_STORM_ACID__
#define __EFFECT_STORM_ACID__
...
class EffectStormAcid : public Effect {
public:
    EffectStormAcid(Creature* pCreature);

public:
    EffectClass getEffectClass() const {
        return EFFECT_CLASS_STORM_ACID;
    }
