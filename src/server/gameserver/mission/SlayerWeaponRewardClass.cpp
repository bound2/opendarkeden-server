...
RewardInfo* SlayerWeaponRewardClass::selectReward(PlayerCreature* pPC) const {
    __BEGIN_TRY
...
QuestMessage SlayerWeaponRewardClass::giveReward(PlayerCreature* pPC) const {
    __BEGIN_TRY
...
string SlayerWeaponRewardClass::toString() const {
