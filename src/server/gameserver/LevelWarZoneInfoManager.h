...
public:
    int getGrade() const {
        return m_LevelWarGrade;
    }
    void setGrade(int grade) {
        m_LevelWarGrade = grade;
    }
    ...
    SweeperBonusType_t getMinSweeperBonusType() const {
        return m_SweeperTypeMin;
    }
    void setMinSweeperBonusType(const SweeperBonusType_t sweeperBonusType) {
        m_SweeperTypeMin = sweeperBonusType;
    }

    SweeperBonusType_t getMaxSweeperBonusType() const {
        return m_SweeperTypeMin;
    }
    void setMaxSweeperBonusType(const SweeperBonusType_t sweeperBonusType) {
        m_SweeperTypeMin = sweeperBonusType;
    }

    Attr_t getMinSlayerSum() const {
        return m_SlayerSumMin;
    }
    void setMinSlayerSum(const Attr_t attr) {
        m_SlayerSumMin = attr;
    }

    Attr_t getMaxSlayerSum() const {
        return m_SlayerSumMax;
    }
    void setMaxSlayerSum(const Attr_t attr) {
        m_SlayerSumMax = attr;
    }

    Level_t getMinVampireLevel() const {
        return m_VampireLevelMin;
    }
    void setMinVampireLevel(const Level_t level) {
        m_VampireLevelMin = level;
    }

    Level_t getMaxVampireLevel() const {
        return m_VampireLevelMax;
    }
    void setMaxVampireLevel(const Level_t level) {
        m_VampireLevelMax = level;
    }

    Level_t getMinOustersLevel() const {
        return m_OustersLevelMin;
    }
    void setMinOustersLevel(const Level_t level) {
        m_OustersLevelMin = level;
    }

    Level_t getMaxOustersLevel() const {
        return m_OustersLevelMax;
    }
    void setMaxOustersLevel(const Level_t level) {
        m_OustersLevelMax = level;
    }

    const list<ZoneID_t>& getZoneIDList() const {
        return m_LevelWarBonusZoneIDList;
    }
