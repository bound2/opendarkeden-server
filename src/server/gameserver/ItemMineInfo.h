...
public:
    ...
    void setItemClass(ItemClass_t itemClass) {
    ...
    const list<OptionType_t>& getItemOptions() const {
        return m_ItemOptions;
    }
    void setItemOptions(const list<OptionType_t>& itemOptions) {
        m_ItemOptions = itemOptions;
    }
