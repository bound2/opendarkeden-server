...
public:
    static constexpr PacketID_t kPacketID = Packet::PACKET_GC_SKILL_TO_TILE_OK_2;
    static constexpr std::string_view kName = "GCSkillToTileOK2";
    static constexpr PacketSize_t kMaxSize{szObjectID + szSkillType + szCoord * 2 + szRange + szDuration + szBYTE +
                                           szWORD + szObjectID * GCSkillToTileOK2::kMaxCount + szBYTE +
