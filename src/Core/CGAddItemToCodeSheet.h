...
private:
    ...
    CoordInven_t m_X = 0;      // Coord X
    CoordInven_t m_Y = 0;      // Coord Y
};
...
public:
    static constexpr PacketID_t kPacketID = Packet::PACKET_CG_ADD_ITEM_TO_CODE_SHEET;
    static constexpr std::string_view kName = "CGAddItemToCodeSheet";
