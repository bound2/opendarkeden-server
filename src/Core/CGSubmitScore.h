...
public:
    static constexpr PacketID_t kPacketID = Packet::PACKET_CG_SUBMIT_SCORE;
    static constexpr std::string_view kName = "CGSubmitScore";
    static constexpr PacketSize_t kMaxSize{szBYTE + szBYTE + szWORD};
