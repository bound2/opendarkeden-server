...
private:
    ...
    ObjectID_t m_ItemObjectID;   // OID of the item to add to the trade list
};
...
public:
    static constexpr PacketID_t kPacketID = Packet::PACKET_GC_TRADE_REMOVE_ITEM;
    static constexpr std::string_view kName = "GCTradeRemoveItem";
