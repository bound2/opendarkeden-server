...
public:
    static constexpr PacketID_t kPacketID = Packet::PACKET_CG_SET_VAMPIRE_HOT_KEY;
    static constexpr std::string_view kName = "CGSetVampireHotKey";
    static constexpr PacketSize_t kMaxSize{szSkillType * 8};
