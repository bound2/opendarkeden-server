...
public:
    static constexpr PacketID_t kPacketID = Packet::PACKET_CG_TRY_JOIN_GUILD;
    static constexpr std::string_view kName = "CGTryJoinGuild";
    static constexpr PacketSize_t kMaxSize{szGuildID + szGuildMemberRank};
