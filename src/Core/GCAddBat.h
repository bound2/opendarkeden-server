...
// class GCAddBat;
//
// When a Bat comes into view, its information is received in this packet.
//////////////////////////////////////////////////////////////////////////////
...
private:
    ...
    string m_Name; // Name of the Bat

    /*
    SpriteType_t m_SpriteType; // Sprite type
    Color_t      m_MainColor;  // Main colour
    Color_t      m_SubColor;   // Sub colour
    */
