...
//
// Requests notification that a guild member has logged on.
//
// *CAUTION*
//
//----------------------------------------------------------------------
...
public:
    ...
    // Serialize packet data to the datagram stream.
    void write(SocketOutputStream& oStream) const;


    // get packet id
    PacketID_t getPacketID() const {
        return PACKET_GS_GUILDMEMBER_LOGON;
    }
...
public:
    static constexpr PacketID_t kPacketID = Packet::PACKET_GS_GUILDMEMBER_LOGON;
    static constexpr std::string_view kName = "GSGuildMemberLogOn";
    ...
    // *OPTIMIZATION HINT*
    // Use const static LGIncomingConnectionPacketMaxSize when possible.
