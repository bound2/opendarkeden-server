...
enum {
    ...
    NPC_RESPONSE_TEAM_REGIST_FAIL_ALREADY_JOIN, // 어디 한번 볼까? 자네는 이미 <team_name> 팀 소속이라고 나와 있군	//
                                                // 26
    NPC_RESPONSE_TEAM_REGIST_FAIL_QUIT_TIMEOUT, // 자네는 다른 팀을 탈퇴한지 얼마 되지 않았군. 조금 더 신중하게 생각하고
                                                // 행동하게	// 27
    NPC_RESPONSE_TEAM_REGIST_FAIL_CANCEL_TIMEOUT, // 자네는 팀을 취소 당한 지 얼마 되지 않았군. 등록 조건에 부합하도록
    // 자신을 좀 더 기르고 오게. 좀 더 신중하게 기회를 엿보도록 하게	//
    // 28
    ...
    NPC_RESPONSE_TEAM_REGIST_FAIL_FAME, // <player_name>이라.. 난 아직 그런 이름은 들어보지도 못했다네. 그건 자네가
    // 풋내기라는 것을 의미하지. 실력을 닦고 다시 찾아오게나	// 31
    ...
    NPC_RESPONSE_TEAM_STARTING_FAIL_QUIT_TIMEOUT, // 자네는 다른 팀을 탈퇴한지 얼마 되지 않았군. 조금 더 신중하게
                                                  // 생각하고 행동하게	// 35
    NPC_RESPONSE_TEAM_STARTING_FAIL_CANCEL_TIMEOUT, // 자네는 팀을 취소 당한 지 얼마 되지 않았군. 조건에 부합하도록
    // 자신을 좀 더 기르고 오게. 좀 더 신중하게 기회를 엿보도록 하게
    // // 36
    ...
    NPC_RESPONSE_TEAM_STARTING_FAIL_FAME, // <player_name>이라.. 난 아직 그런 이름은 들어보지도 못했다네. 그건 자네가
    // 풋내기라는 것을 의미하지. 실력을 닦고 다시 찾아오게나	// 39
    NPC_RESPONSE_TEAM_STARTING_FAIL_DENY, // 거부되었습니다.	// 40

    NPC_RESPONSE_CLAN_REGIST_FAIL_ALREADY_JOIN, // 어디 한번 볼까? 자네는 이미 <clan_name> 클랜과 서약을 맺은 상태라고
                                                // 나와있군	// 41
    NPC_RESPONSE_CLAN_REGIST_FAIL_QUIT_TIMEOUT, // 자네는 다른 클랜을 탈퇴한지 얼마되지 않았군. 나무 이리저리 옮겨
                                                // 다니는 것은 좋지 않지. 신중을 기하게	// 42
    NPC_RESPONSE_CLAN_REGIST_FAIL_CANCEL_TIMEOUT, // 자네는 클랜을 취소 당한 지 얼마 되지 않았군. 좀 더 신중하게 기회를
                                                  // 엿보도록 하게	// 43
    ...
    NPC_RESPONSE_CLAN_REGIST_FAIL_FAME, // <player_name>이라.. 아직 어린 뱀파이어인가보군. 더 많은 피를 마시고 다시
                                        // 찾아오게나.	// 46
    ...
    NPC_RESPONSE_CLAN_STARTING_FAIL_QUIT_TIMEOUT, // 자네는 다른 클랜을 탈퇴한지 얼마되지 않았군. 나무 이리저리 옮겨
                                                  // 다니는 것은 좋지 않지. 신중을 기하게	// 50
    NPC_RESPONSE_CLAN_STARTING_FAIL_CANCEL_TIMEOUT, // 자네는 클랜을 취소 당한 지 얼마 되지 않았군. 좀 더 신중하게
                                                    // 기회를 엿보도록 하게	// 51
    NPC_RESPONSE_CLAN_STARTING_FAIL_LEVEL, // 훌륭한 조력자가 되기에는 자질이 좀 부족한 것 같군. 가서 좀더 수련을 하고
                                           // 오게나	// 52
    NPC_RESPONSE_CLAN_STARTING_FAIL_MONEY, // 기술이 월등해도 클랜을 유지할 수 있는 돈이 부족하면 그 클랜은 무너지기
                                           // 쉽상이지	// 53
    NPC_RESPONSE_CLAN_STARTING_FAIL_FAME, // <player_name>이라.. 난 아직 그런 이름은 들어보지도 못했다네. 그건 자네가
    // 풋내기라는 것을 의미하지. 실력을 닦고 다시 찾아오게나	// 54
    ...
    NPC_RESPONSE_GUILD_REGIST_FAIL_ALREADY_JOIN, // 어디 한번 볼까? 자네는 이미 <guild_name> 길드 소속이라고 나와 있군
                                                 // // 105
    NPC_RESPONSE_GUILD_REGIST_FAIL_QUIT_TIMEOUT, // 자네는 다른 길드를 탈퇴한지 얼마 되지 않았군. 조금 더 신중하게
                                                 // 생각하고 행동하게	// 106
    NPC_RESPONSE_GUILD_REGIST_FAIL_CANCEL_TIMEOUT, // 자네는 길드를 취소 당한 지 얼마 되지 않았군. 등록 조건에
    // 부합하도록 자신을 좀 더 기르고 오게. 좀 더 신중하게 기회를
    // 엿보도록 하게	// 107
    ...
    NPC_RESPONSE_GUILD_REGIST_FAIL_FAME, // <player_name>이라.. 난 아직 그런 이름은 들어보지도 못했다네. 그건 자네가
    // 풋내기라는 것을 의미하지. 실력을 닦고 다시 찾아오게나	// 110
    ...
    NPC_RESPONSE_GUILD_STARTING_FAIL_QUIT_TIMEOUT, // 자네는 다른 길드를 탈퇴한지 얼마 되지 않았군. 조금 더 신중하게
                                                   // 생각하고 행동하게	// 114
    NPC_RESPONSE_GUILD_STARTING_FAIL_CANCEL_TIMEOUT, // 자네는 길드를 취소 당한 지 얼마 되지 않았군. 조건에 부합하도록
    // 자신을 좀 더 기르고 오게. 좀 더 신중하게 기회를 엿보도록 하게
    // // 115
    ...
    NPC_RESPONSE_GUILD_STARTING_FAIL_FAME, // <player_name>이라.. 난 아직 그런 이름은 들어보지도 못했다네. 그건 자네가
    // 풋내기라는 것을 의미하지. 실력을 닦고 다시 찾아오게나	// 118
    ...
    NPC_RESPONSE_ALREADY_REINFORCE_ACCEPTED, // 수비측 참전 신청이 허가된 길드가 이미 있어서 신청할 수 없습니다.	//
                                             // 122
    ...
    NPC_RESPONSE_SHOW_DONATION_COMPLETE_DIALOG, // 기부해주신 금액은 온정의 손길이 필요한 불우한 이웃을 위하여 소중하게
                                                // 쓰여질 것입니다. 모금에 참여해주셔서 감사합니다.
    ...
    NPC_RESPONSE_SHOW_ALEADY_DONATED_DIALOG,            // 이미 축의금의 내셨습니다.
