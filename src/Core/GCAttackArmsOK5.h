...
public:
    static constexpr PacketID_t kPacketID = Packet::PACKET_GC_ATTACK_ARMS_OK_5;
    static constexpr std::string_view kName = "GCAttackArmsOK5";
    static constexpr PacketSize_t kMaxSize{szSkillType + szObjectID + szObjectID + szbool};
