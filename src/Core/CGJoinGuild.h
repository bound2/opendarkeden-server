...
public:
    static constexpr PacketID_t kPacketID = Packet::PACKET_CG_JOIN_GUILD;
    static constexpr std::string_view kName = "CGJoinGuild";
    static constexpr PacketSize_t kMaxSize{szGuildID + szGuildMemberRank + szBYTE + 256};
