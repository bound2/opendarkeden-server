...
check_ratchet R1 "global singleton externs" 12 "$R1"
...
check_ratchet R5 "__BEGIN_TRY sites in gameserver" 5167 "$R5"
...
check_ratchet R17 "source lines carrying non-ASCII bytes" 577 "$R17"
