...
check_ratchet R1 "global singleton externs" 89 "$R1"
...
# and Vampire members -- the castle skills, the all-stat recalculation and
# the item, option and blood bible contributions to it -- live in
# SlayerStat.cpp / VampireStat.cpp.
R6b=$(wc -l < src/server/gameserver/InitAllStat.cpp 2>/dev/null || echo missing)
check_ratchet R6b "InitAllStat.cpp lines" 1735 "$R6b"
