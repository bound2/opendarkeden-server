...
# members -- the castle skills, the all-stat recalculation and the item,
# option and blood bible contributions to it -- live in SlayerStat.cpp.
R6b=$(wc -l < src/server/gameserver/InitAllStat.cpp 2>/dev/null || echo missing)
check_ratchet R6b "InitAllStat.cpp lines" 2945 "$R6b"
