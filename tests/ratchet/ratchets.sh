...
check_ratchet R1 "global singleton externs" 0 "$R1"
...
check_ratchet R5 "__BEGIN_TRY sites in gameserver" 5146 "$R5"
...
check_ratchet R17 "source lines carrying non-ASCII bytes" 572 "$R17"
